            ...
            <nav class="bg-blue-500 border-b border-gray-100">
                        ...
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                ...
                                <template v-if="!$page.props.auth.user.is_admin">
                                    <NavLink :href="route('menjador')" :active="route().current('menjador')">
                                        Menjador
                                    </NavLink>
                                    <NavLink :href="route('encomanar')" :active="route().current('encomanar')">
                                        Encomanar
                                    </NavLink>
                                </template>
                                <template v-else>
                                    <NavLink :href="route('admin.comandes')" :active="route().current('admin.comandes')">
                                        Comandes
                                    </NavLink>
                                    <NavLink :href="route('admin.reserves')" :active="route().current('admin.reserves')">
                                        Reserves
                                    </NavLink>
                ...
                <div :class="{ 'block': showingNavigationDropdown, 'hidden': !showingNavigationDropdown }"
                    ...
                    <div class="pt-2 pb-3 space-y-1">
                        ...
                        <template v-if="!$page.props.auth.user.is_admin">
                            <ResponsiveNavLink :href="route('menjador')" :active="route().current('menjador')">
                                Menjador
                            </ResponsiveNavLink>
                            <ResponsiveNavLink :href="route('encomanar')" :active="route().current('encomanar')">
                                Encomanar
                            </ResponsiveNavLink>
                        </template>
                        <template v-else>
                            <ResponsiveNavLink :href="route('admin.comandes')" :active="route().current('admin.comandes')">
                                Comandes
                            </ResponsiveNavLink>
                            <ResponsiveNavLink :href="route('admin.reserves')" :active="route().current('admin.reserves')">
                                Reserves
                            </ResponsiveNavLink>
